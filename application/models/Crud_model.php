    ...
    public function add_lesson()
    {
        ...
        public function edit_lesson($lesson_id)
        {
            ...
            function curl_request($code = '')
            {
                ...
                //function to get courses by category including children categories
                public function get_courses_by_cat($category_id){
                    return $this->db->get_where('course', array('sub_category_id' => $category_id));
                }
